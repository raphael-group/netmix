...
from common import em, responsibility, log_likelihood_ratio, load_node_score, save_node_score, load_nodes
...
def get_parser():
    ...
    parser.add_argument('-tc', '--threshold_choice', type=str, choices=['mixing_proportions', 'natural'], default='mixing_proportions', help='Choose score threshold')
